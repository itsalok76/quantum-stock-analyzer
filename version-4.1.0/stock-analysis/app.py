...
with st.sidebar:
    ...
    st.caption("v4.1.0 — Interactive Dashboard")
...
if "results" not in st.session_state:
    ...
    st.subheader("v4.1.0 — Interactive Dashboard")
    st.markdown("---")
    st.markdown(
        "**Getting started:**\n\n"
        ...
        "entanglement → QFT → QPE → VQC optimisation → quantum trajectory"
    )
...
PAGE_MAP = {
    ...
    "Quantum Trajectory"           : page_trajectory,
