...
**Version 3.1.0** — Interactive Dashboard
...
Circuit, and present everything in an interactive web dashboard.
...
The dashboard is the primary interface for v3.1. It runs the full pipeline
...
2. Choose number of historical days (90–730)
