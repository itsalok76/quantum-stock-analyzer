...
**Version 3.0.0** — Quantum Portfolio Optimizer

A Python + Qiskit framework that combines classical financial analytics with
quantum computing to analyse NSE stocks, encode market features into quantum
states, and optimise portfolio allocation using a Variational Quantum Circuit.
...
7. [Quantum Modules](#quantum-modules)
8. [Output Files](#output-files)
9. [IBM watsonx AI (Optional)](#ibm-watsonx-ai-optional)
...
| `--days` / `-d` | No | 180 | Number of historical calendar days to analyse |
